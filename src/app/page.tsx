          ...
          <div className="gap-2 flex justify-between">
            <div className="flex-col flex flex-1 space-y-1">
              ...
              <GradualSpacing
                ...
                text={DATA.name.split(" ")[2]}
              />
              <WordPullUp
                className="max-w-[600px] md:text-4xl text-lg font-light tracking-[-0.02em] text-black dark:text-white"
      ...
      <section id="skills">
        <div className="flex min-h-0 flex-col gap-y-3">
          <BlurFade delay={BLUR_FADE_DELAY * 9}>
            <h2 className="text-xl font-bold">Skills & Interest</h2>
          </BlurFade>
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                if you want to chat. I&apos;ll do my best to reply whenever I&apos;m free—just no spam, please!
              </p>
            </div>
          </BlurFade>
        </div>
